...
if total(playerHand) == 21:
    ...
    print(f"\nYou have {playerHand} for a total of {total(dealerHand)} and the dealer has {dealerHand} for a total of {total(dealerHand)}")
    print("Dealer busts! You win!")
elif 21 - total(dealerHand) < 21 - total(playerHand):
    print(f"\nYou have {playerHand} for a total of {total(playerHand)} and the dealer h{dealerHand} for a total of {total(dealerHand)}")
    print("Dealer Wins!")
elif 21 - total(dealerHand) < 21 - total(playerHand):
    print(f"\nYou have {playerHand} for a total of {total(playerHand)} and the dealer h{dealerHand} for a total of {total(dealerHand)}")
    print("Yu Wins!")
